...
## System Architecture 
![](images/architecture_0002.png){width=600px}
...
![](images/packages.png){width=400px}
...
# Results 
![](images/analysis_1.jpg){width=600px}
...
![](images/analysis_2.jpg){width=600px}
...
![](images/analysis_3.jpg){width=600px}
...
references:
- id: seoulsg
  title: AGE-FRIENDLY CITIES - Lessons from Seoul and Singapore
  URL: 'https://www.clc.gov.sg/docs/default-source/books/book-age-friendly-cities.pdf'
  ...
  issued:
    year: 2019
- id: straitstimes
  title: Free entry to public gyms and pools for seniors
  author:
  - family: Chia
    given: Nicole
  URL: 'https://www.straitstimes.com/singapore/free-entry-to-public-gyms-and-pools-for-seniors'
  ...
  issued:
    ...
    month: 3
- id: mdpi
  title: Spatial Distribution Characteristics of Healthcare Facilities in Nanjing: Network Point Pattern Analysis and Correlation Analysis
  author:
  - family: Ni
    given: Jianhua
  - family: Qian
  ...
  - family: Wang
    given: Jiechen
  URL: 'https://www.mdpi.com/1660-4601/13/8/833'
  DOI: 10.3390/ijerph13080833
  publisher: MDPI
  type: article-journal
  issued:
    year: 2016
...
- id: gwss
  ...
  - family: Brunsdon
    given: Chris
  URL: 'https://rstudio-pubs-static.s3.amazonaws.com/503649_13027b8d4636466d93917435af74aea3.html'
  type: article-journal
  issued:
    year: 2019
    month: 7    
